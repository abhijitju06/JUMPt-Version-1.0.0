function LSE_Lys_Prot = GO_lsqnonlin(param, tspan, Lys_P_ratio, EtaP,SILAC_food_impurity, setting)
    if setting == 3
    ...
    if setting == 2
        ...
        [t,Lys_P] = ode15s(@(t,y0)PT_ODE_Ratio(t,y0,[param(1:end-1) param(end)],SILAC_food_impurity ),tspan,Lys_P_init);
